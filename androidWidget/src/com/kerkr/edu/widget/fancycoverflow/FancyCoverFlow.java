...
package com.kerkr.edu.widget.fancycoverflow;
...
public class FancyCoverFlow extends Gallery {
    ...
    private float scaleHGravity = SCALEDOWN_GRAVITY_CENTER;
     ...
     * @return
     */
    public float getScaleHGravity() {
        return scaleHGravity;
    }
     ...
     */
    public void setScaleHGravity(float scaleHGravity) {
        this.scaleHGravity = scaleHGravity;
    }
    /**
     * TODO: Doc
     *
    ...
    protected boolean getChildStaticTransformation(View child, Transformation t) {
        ...
        if (this.unselectedScale != 1) {
            ...
            final float translateX = childWidth * this.scaleHGravity;
