...
public class RippleViewButton extends Button {
    ...
    public RippleViewButton(Context context, AttributeSet attrs, int defStyle) {
        ...
        mRippleColor = a.getColor(R.styleable.RippleViewButton_button_rippleColor,
                mRippleColor);
        mAlphaFactor = a.getFloat(R.styleable.RippleViewButton_alphaFactor,
                mAlphaFactor);
        mHover = a.getBoolean(R.styleable.RippleViewButton_hover, mHover);
        a.recycle();
    }
        ...
        if (event.getActionMasked() == MotionEvent.ACTION_DOWN
            ...
            mRadiusAnimator.addListener(new Animator.AnimatorListener() {
                ...
                public void onAnimationEnd(Animator animator) {
                    setRadius(0);
                    ViewHelper.setAlpha(RippleViewButton.this, 1);
                    mIsAnimating = false;
                }
