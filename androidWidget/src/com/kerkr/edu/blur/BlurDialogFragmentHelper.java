...
public class BlurDialogFragmentHelper {
    ...
    public void onActivityCreated() {
        ...
        BlurUtill.setAlpha(mBlurBgView, 0f);

        mBlurImgView = new ImageView(mFragment.getActivity());
        BlurUtill.setAlpha(mBlurImgView, 0f);
        ...
        Bitmap bitmap = BlurUtill.drawViewToBitmap(mRoot, mRoot.getWidth(),
                visibleFrame.bottom, 0, visibleFrame.top, 3);
        Bitmap blurred = FastBlur.doBlurRenderScript(mFragment.getActivity(), bitmap,10,false);
    ...
    private void startEnterAnimation() {
    	BlurUtill.animateAlpha(mBlurBgView, 0f, 1f, mAnimDuration, null);
    	BlurUtill.animateAlpha(mBlurImgView, 0f, 1f, mAnimDuration, null);
    }

    private void startExitAnimation() {
    	BlurUtill.animateAlpha(mBlurBgView, 1f, 0f, mAnimDuration, null);
    	BlurUtill.animateAlpha(mBlurImgView, 1f, 0f, mAnimDuration, new Runnable() {
            @Override
            public void run() {
