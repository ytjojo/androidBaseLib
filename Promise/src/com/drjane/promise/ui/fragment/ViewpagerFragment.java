...
public class ViewpagerFragment extends BaseFragment implements View.OnClickListener {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        final ScreenSlidePagerAdapter screenSlidePagerAdapter = new ScreenSlidePagerAdapter(getChildFragmentManager());
        mViewPager.setAdapter(screenSlidePagerAdapter);
        mViewPager.setCurrentItem(500);
        month = Calendar.getInstance().get(Calendar.YEAR) + "-" + Utils.LeftPad_Tow_Zero(Calendar.getInstance().get(Calendar.MONTH) + 1);
        ...
        mViewPager.setOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                month = calendar.get(Calendar.YEAR) + "-" + Utils.LeftPad_Tow_Zero(calendar.get(Calendar.MONTH) + 1);
                currentMonth.setText(month);
            }
    ...
    public void setNavigations() {
        setTitle("Promise");
        setNavigation(R.drawable.ic_action_image_timer_auto, new View.OnClickListener() {
            
            @Override
            public void onClick(View v) {
                DrawerToast.getInstance(getApplicationContext()).show("列表");
