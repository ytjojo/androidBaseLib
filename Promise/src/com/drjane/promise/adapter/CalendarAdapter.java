package com.drjane.promise.adapter;
...
public class CalendarAdapter extends BaseAdapter {
    ...
    public CalendarAdapter(Context context, Calendar c) {
        this();
        this.context = context;
        sc = new SpecialCalendar();
        lc = new LunarCalendar();
        this.res = context.getResources();
        currentYear = String.valueOf(c.get(Calendar.YEAR));// 得到跳转到的年份
        currentMonth = String.valueOf(c.get(Calendar.MONTH) + 1); // 得到跳转到的月份
        currentDay = String.valueOf(c.get(Calendar.DAY_OF_MONTH) + 1); // 得到跳转到的天
        getCalendar(Integer.parseInt(currentYear), Integer.parseInt(currentMonth));
    }
