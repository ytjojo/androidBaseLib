...
public class Database extends SQLiteOpenHelper {
    ...
    public static long create(Alarm alarm) {
        ...
        cv.put(COLUMN_ALARM_TIME, wrapper.getAlarmTimeString());
    ...
    public static Alarm getAlarm(int id) {
        ...
        String[] columns = new String[] { COLUMN_ALARM_ID, COLUMN_ALARM_ACTIVE, COLUMN_ALARM_TIME, COLUMN_ALARM_DAYS, COLUMN_ALARM_DIFFICULTY,
        ...
        if (c.moveToFirst()) {
            ...
            AlarmWrapper wrapper = new AlarmWrapper(alarm);
            wrapper.setAlarmTime(c.getString(3));
    ...
    public void onCreate(SQLiteDatabase db) {
        // TODO Auto-generated method stub
        db.execSQL("CREATE TABLE IF NOT EXISTS " + ALARM_TABLE + " ( " + COLUMN_ALARM_ID + " INTEGER primary key autoincrement, "
                + COLUMN_ALARM_ACTIVE + " INTEGER NOT NULL, " + COLUMN_ALARM_TIME + " TEXT NOT NULL, " + COLUMN_ALARM_DAYS + " BLOB NOT NULL, "
                + COLUMN_ALARM_DIFFICULTY + " INTEGER NOT NULL, " + COLUMN_ALARM_TONE + " TEXT NOT NULL, " + COLUMN_ALARM_VIBRATE
                + " INTEGER NOT NULL, " + COLUMN_ALARM_NAME + " TEXT NOT NULL)");
    }
    ...
    public static List<Alarm> getAll() {
        ...
        if (cursor.moveToFirst()) {
            ...
            do {
                ...
                AlarmWrapper wrapper = new AlarmWrapper(alarm);
                wrapper.setAlarmTime(cursor.getString(2));
