...
public class AlarmService extends Service {
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		...
		if(null != alarm){
		    ...
		    wrapper.schedule(getApplicationContext());
			Log.d(this.getClass().getSimpleName(),wrapper.getTimeUntilNextAlarmMessage());
			
		}else{
			Intent myIntent = new Intent(getApplicationContext(), AlarmServiceBroadcastReciever.class);
