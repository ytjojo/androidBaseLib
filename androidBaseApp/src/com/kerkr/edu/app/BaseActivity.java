...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    public ViewGroup mContentScreenView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!isNeedSetUpFragment()|| getRootFragmentClass() == null) {
            return;
        }
        setContentView(R.layout.base_fragment);
        if (getRootFragmentClass() != null) {
            mFragmentStack = new FragmentStack(this, R.id.container, getRootFragmentClass());
            mFragmentStack.setupRoot(savedInstanceState);
        }
        initContainerView(R.id.activity_screen_layout);
        setupToolbar();
        
    }
    
    public void initContainerView(int screenLayout) {
        mWorkSpaceView = (FrameLayout) findViewById(R.id.container);
        if (screenLayout > 0) {
            
            mContentScreenView = (ViewGroup) findViewById(screenLayout);
        }
        else {
            
            mContentScreenView = (ViewGroup) findViewById(R.id.activity_screen_layout);
        }
    }
    ...
    public void pushFragmentToBackStack(Class<? extends BaseFragment> cls, Bundle args) {
        if (cls == null) {
            return;
        }
    ...
    public void hideNavigationBar(){
        ...
        mContentScreenView.setSystemUiVisibility(View.SYSTEM_UI_FLAG_HIDE_NAVIGATION);
    }
    /**
     * 界面颜色的更改
     */
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        if(mFragmentStack != null)
        getSupportFragmentManager().putFragment(outState, getRootFragmentClass().toString(), mFragmentStack.getRootFragment());
    }
