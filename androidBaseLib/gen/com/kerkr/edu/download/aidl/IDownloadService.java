 ...
 * Original file: E:\\workspace\\hyr\\androidBaseLib\\src\\com\\kerkr\\edu\\download\\aidl\\IDownloadService.aidl
 */
package com.kerkr.edu.download.aidl;
public interface IDownloadService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.kerkr.edu.download.aidl.IDownloadService
{
private static final java.lang.String DESCRIPTOR = "com.kerkr.edu.download.aidl.IDownloadService";
...
/**
 * Cast an IBinder object into an com.kerkr.edu.download.aidl.IDownloadService interface,
 * generating a proxy if needed.
 */
public static com.kerkr.edu.download.aidl.IDownloadService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.kerkr.edu.download.aidl.IDownloadService))) {
return ((com.kerkr.edu.download.aidl.IDownloadService)iin);
}
return new com.kerkr.edu.download.aidl.IDownloadService.Stub.Proxy(obj);
}
...
private static class Proxy implements com.kerkr.edu.download.aidl.IDownloadService
{
