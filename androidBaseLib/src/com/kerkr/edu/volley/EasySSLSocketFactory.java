...
public class EasySSLSocketFactory implements LayeredSocketFactory {
    ...
    private static SSLContext createEasySSLContext() throws IOException {
        try {
            ...
            InputStream clientStream = BaseApplication.getInstance().getResources().openRawResource(R.raw.production_test_client);
	        ...
	        instream = BaseApplication.getInstance().getResources().openRawResource(R.raw.production_test_ca);
