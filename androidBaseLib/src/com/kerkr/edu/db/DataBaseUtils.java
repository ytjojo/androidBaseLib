...
public class DataBaseUtils {
    ...
    public static boolean copyDateBaseToMemory(Context context, String dbname, int resource,String signName) {
        ...
        try {
            ...
            VALog.d(context.getDatabasePath(dbname).getAbsolutePath() + "  " + context.getApplicationContext().getPackageResourcePath());
