...
//				// execute...!
//			    VALog.i( " 1 connect to network now..");
...
//		  VALog.i( "sleep 6000ms, second call");
...
//			protected User doConnectNetwork() {
//				// noooo execute...!
//			    VALog.i(  " 2 connect to network now.. 你将看不到这行日志。因为未超时它不会被执行");
//				return mockhttpGetUserInfo();
//			}
//		}.execute();
//		SystemClock.sleep(6000);
//		VALog.i(  "sleep 6000ms again, third call");
...
//			protected User doConnectNetwork() {
//				// execute...!
//			    VALog.i(  " 3 connect to network now..");
//			    VALog.i( " 3  取自互联网（虚拟）");
//				return mockhttpGetUserInfo();
//			}
//		}.execute();
...
//     */
//    @Override
//    public boolean isNeadSetUpFragment() {
