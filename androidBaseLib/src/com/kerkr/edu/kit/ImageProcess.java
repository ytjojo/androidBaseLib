...
import com.kerkr.edu.compatible.CloseableUtil;
import com.kerkr.edu.log.VALog;
import com.kerkr.edu.utill.CompatUtil;
import com.kerkr.edu.utill.SDCardUtils;
...
public class ImageProcess {
    public static final String TAG = ImageProcess.class.getSimpleName();
    ...
    public static Bitmap fastBlur(Bitmap bm, View view, boolean downScale, float scaleF) {
        ...
        VALog.d("fast blur takes: " + (System.currentTimeMillis() - startMs + "ms"));
        return overlay;
...
//        canvas.translate(-view.getLeft()/scaleFactor, -view.getTop()/scaleFactor);
    ...
    public static void fastBlurSetBg(Context context, Bitmap bm, View view, boolean downScale, float scaleFactor) {
        ...
        if (null == overlay) {
            VALog.e( "fast blur error(result[overlay] is null)");
            return;
        }
        CompatUtil.setBackground(view, new BitmapDrawable(context.getResources(), overlay));
    }
    /***************************************BLUR END****************************************/
...
//        Bitmap b = BitmapFactory.decodeFile(filePath, options);
        ...
        BitmapUtils.recycleBitmap(smallBm);
        return zoomBm;
    }
...
//        float ww = 480f;//这里设置宽度为480f
        ...
        try {
            ...
            CloseableUtil.closeQuietly(isBm);
            CloseableUtil.closeQuietly(os);
...
//        float ww = 480f;//这里设置宽度为480f
        ...
        try {
            ...
            BitmapUtils.recycleBitmap(bitmap);
            CloseableUtil.closeQuietly(commpressedBm);
        }
        return resultBm;
    }
...
//		Bitmap originalBitmap = drawableToBitmap(drawable);
    ...
    public static Drawable zoomDrawable(Drawable drawable, int w, int h) {
        ...
        Bitmap newbmp = Bitmap.createBitmap(oldbmp, 0, 0, width, height,
                matrix, true);
        BitmapUtils.recycleBitmap(oldbmp);
    ...
    public static Bitmap formatCameraPicture(String path) {
        ...
        BitmapUtils.recycleBitmap(cbitmap);
        return newbitmap;
    }
