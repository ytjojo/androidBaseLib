 ...
 */
package com.kerkr.edu.persistence;

import java.lang.reflect.Field;

import com.kerkr.edu.app.BaseApplication;
import com.kerkr.edu.reflect.FieldUtils;
 ...
 * @version V1.0
 */
public class PreferenceConfig implements IPersistence
{
	private static IPersistence mPreferenceConfig;
	 ...
	 * @return
	 */
	public static IPersistence getPreferenceConfig()
	{
		if (mPreferenceConfig == null)
		{
			mPreferenceConfig = new PreferenceConfig();
		}
	...
	public void setConfig(Object entity)
	{
		...
		for (Field field : fields)
		{
			...
			if (!FieldUtils.isTransient(field))
			{
				if (FieldUtils.isBaseDateType(field))
				{
					String columnName = FieldUtils.getFieldName(field);
